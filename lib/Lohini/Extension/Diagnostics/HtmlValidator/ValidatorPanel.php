 ...
 */
namespace Lohini\Extension\Diagnostics\HtmlValidator;
/**
...
implements \Nette\Diagnostics\IBarPanel
{
	...
	public function getTab()
	{
		...
		$img=\Nette\Utils\Html::el('img')->src($data(file_get_contents(__DIR__.'/icon.png')))->height('16px');
