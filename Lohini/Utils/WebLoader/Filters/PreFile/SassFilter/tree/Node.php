...
class Node
{
	...
	public function __get($name)
	{
		...
		throw new Sass\NodeException("No getter function for $name", $this);
	}
	...
	public function __set($name, $value)
	{
		...
		throw new Sass\NodeException("No setter function for $name", $this);
	}
	...
	{
		if ($child instanceof Sass\ElseNode) {
			if (!$this->lastChild instanceof Sass\IfNode) {
	...
	{
		return $this->parent instanceof Sass\ForNode
				|| $this->parent->parent instanceof Sass\ForNode
				|| $this->parent instanceof Sass\IfNode
				|| $this->parent->parent instanceof Sass\IfNode
				|| $this->parent instanceof Sass\WhileNode
				|| $this->parent->parent instanceof Sass\WhileNode;
	}
