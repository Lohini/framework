 ...
 */
namespace BailIff\Localization\Storages;
/**
...
use Nette\Utils\Strings,
	BailIff\Localization\Dictionary;
...
implements \BailIff\Localization\IStorage
{
	/** @var string */
	private $fileMask;
	...
	private function processMetadata($metadata, $lang)
	{
		...
		if (isset($metadata['Plural-Forms'])) {
			...
			$pform=\BailIff\Localization\PluralForms::ruleByLanguage($lang);
