...
implements ITranslator
{
	...
	/** @var \BailIff\Localization\IStorage */
	private $storage;
	...
	/**
	 * @return \BailIff\Localization\IStorage
	 */
	protected function getStorage()
	{
		if (!$this->storage) {
			$this->storage=new \BailIff\Localization\Storages\Gettext; // default storage
		}
		return $this->storage;
	}
	
	/**
	 * @param \BailIff\Localization\IStorage
	 * @return \BailIff\Localization\Translator
	 */
	 ...
	 * @param string $name
	 * @param string $dir
	 * @param \BailIff\Localization\IStorage $storage
