...
extends \Nette\Application\UI\Control
{
	...
	/**
	 * @return \BailIff\Components\TreeView\TreeViewLink
	 */
	...
	{
		$this->load();
		return $this->getComponents(FALSE, 'BailIff\Components\TreeView\TreeViewNode');
	}
	...
	{
		return $this->getPresenter()->context->session->getSection('BailIff.TreeView/'.$this->getTreeView()->getName().'/'.$this->getName());
	}
	...
	{
		return $this->lookup('BailIff\Components\TreeView\TreeView');
	}
}
