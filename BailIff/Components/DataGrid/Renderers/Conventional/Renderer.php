...
use Nette\Utils\Html,
	BailIff\Components\DataGrid\Columns\ActionColumn;
...
implements IRenderer
{
	...
	public $file;
	/** @var \BailIff\Components\DataGrid\DataGrid */
	protected $dataGrid;
	 ...
	 * @param \BailIff\Components\DataGrid $dataGrid
	 * @param string $mode
	 * @return string
...
// body
	...
	public function renderPaginator()
	{
		...
		$a=Html::el('a');
		$a->addClass(\BailIff\Components\DataGrid\Action::$ajaxClass);
...
// headers
		foreach ($this->dataGrid->getColumns() as $column) {
			...
			if ($column->isOrderable()) {
				...
				$up=clone $down=Html::el('a')->addClass(\BailIff\Components\DataGrid\Columns\Column::$ajaxClass);
				...
				$value=(string)Html::el('a')->href($column->getOrderLink())
							->addClass(\BailIff\Components\DataGrid\Columns\Column::$ajaxClass)->setHtml($text).$positioner;
				}
			else {
