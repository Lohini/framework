 ...
 * @service(class="BailIff\Database\Models\Services\Identities")
 ...
 */
class Identity
extends \BailIff\Database\Doctrine\ORM\Entities\BaseEntity
implements \BailIff\Database\Models\IEntity, \Nette\Security\IIdentity, \Serializable
{
	/**
	 * @id @generatedValue
	 * @column(type="integer")
	...
	/**
	 * @return \BailIff\Database\Models\Entities\User
	 */
	 ...
	 */
	public function load(\BailIff\Database\Doctrine\ORM\Container $container)
	{
		if (!$this->loaded) {
