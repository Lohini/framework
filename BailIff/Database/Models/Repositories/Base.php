...
//implements \Kdyby\Validation\IStorage
{
	 ...
	 *
	 * @param string $alias
	 * @return \BailIff\Database\Models\QueryBuilder $alias
	 */
	...
	/**
	 * @return \BailIff\Database\Models\QueryBuilder
	 */
	...
	public function countByAttribute($attribute, $value)
	{
		...
		try {
			...
			throw new \BailIff\Database\Doctrine\QueryException($e->getMessage(), $this->qb->getQuery(), $e);
			}
	}
